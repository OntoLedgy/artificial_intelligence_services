...
class PDFSummarizer:
    def __init__(self, pdf_path: str, openai_api_key):
    ...
    def create_summary_chain(self):
        self.summarizer_chain = load_summarize_chain(self.llm, chain_type="map_reduce")
    ...
    def summarize(self):
        ...
        summary = self.summarizer_chain.run(self.documents)
