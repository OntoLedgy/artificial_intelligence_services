...
class Embeddings:
    ...
    def create(self):
        article_embeddings = self.model.encode(self.documents, convert_to_tensor=False)
    ...
    def save(self):
        ...
        faiss.write_index(self.index, self.index_file_full_path)

        np.save(self.file_metadata, self.documents)
