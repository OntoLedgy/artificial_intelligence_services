...
class TestConfigurationParsers:
    ...
    def test_parse_configuration_with_invalid_file(
            self):
        assert False
    
    
    def test_parse_configuration_with_invalid_json(
            self):
        assert False
    
    
    def test_parse_configuration_with_missing_fields(
            self):
        assert False
    
    
    def test_parse_configuration_with_invalid_fields(
            self):
        assert False
