...
from services.data_preparation.text_from_word_document_sections_extractor import extract_text_from_word_document_sections
...
class TestOpenAiGraphRetrieverWordDocument:
    ...
    def setup_method(
        ...
        word_document_file_name = \
            r'STIDS 2024 - Formalizing Informational Intelligence Uncertainty - v0.038 CPa - final format - word document.docx'
        
        self.word_document_path = \
            os.path.join(
