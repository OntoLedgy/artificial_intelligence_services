...
def create_context(
    ...
    # Allow any DataDictionary-like object (even if loaded under a different module alias)
    if not hasattr(data_dictionary, "table_schemas") or not hasattr(data_dictionary, "table_column_names_dict"):
        raise AssertionError("Must provide a `DataDictionary` object.")
