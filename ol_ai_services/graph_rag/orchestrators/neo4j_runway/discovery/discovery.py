...
class Discovery:
    ...
    def __init__(
        ...
        # handle TableCollection (including any alias-loaded instances)
        elif isinstance(data, TableCollection) or (
            hasattr(data, "tables") and hasattr(data, "data_dictionary")
        ):
            self.data = data
        else:
            raise ValueError(
